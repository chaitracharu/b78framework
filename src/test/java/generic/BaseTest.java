...
public class BaseTest {
	...
	
	{
       ...
       {
		driver=new RemoteWebDriver( new URL("https://localhost:4444"),new ChromeOptions());
       }
       else if(browser.equalsIgnoreCase("firefox"))
       {
    	   driver=new RemoteWebDriver( new URL("https://localhost:4444"),new FirefoxOptions());;
       }
       else
       {
    	   driver=new RemoteWebDriver( new URL("https://localhost:4444"),new EdgeOptions());;
       }
		driver.get(appURL);
